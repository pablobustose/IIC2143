...
ActiveRecord::Schema[7.0].define(version: 2023_06_14_235224) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.text "image_data"
    t.integer "id_vendedor"
    t.integer "cantidad_xs"
    t.integer "cantidad_s"
    t.integer "cantidad_m"
    t.integer "cantidad_l"
    t.integer "cantidad_xl"
  end
